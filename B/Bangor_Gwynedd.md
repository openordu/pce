...
attributes:
  ...
  - Bangor was rebuilt after Viking attack and a fire set by King John
...
entities:
  ...
  - University of Wales Bangor(Institution)
  - George Gilbert Scott(Person)
tags:
  - Bangor
  - Saint Deiniol
...
```
``` tab [group1:Sources]
- Koch 2006, s.v. 'Bangor (Gwynedd)'
- Monaghan, Patricia. The Encyclopedia of Celtic Mythology and Culture. Checkmark Books, 2008.
```
